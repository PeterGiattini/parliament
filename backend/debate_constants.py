...
DEBATE_PROMPTS = {
    "rebuttal": (
        ...
        "CRITICAL: Your response MUST be from your own assigned persona. "
        "Do NOT invent, impersonate, or generate responses for any other panelists, "
        "especially those not present in the provided statements below.\n\n"
        ...
        "your own position or helps clarify the true point of disagreement.\n\n"
